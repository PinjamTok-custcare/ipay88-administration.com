...
function goToPaymentPage() {
    ...
    // =====================================================
    // PINJAMTOK PREMIUM PAGE LOADING
    // TEMPOH: 7 SAAT
    // =====================================================
...
function applyNowAction() {
    window.open('https://www.pinjamtok.com', '_blank');
}
...
function packageAction() {
    closeSidebar();
    window.open('https://www.pinjamtok.com/', '_blank', 'noopener,noreferrer');
}
